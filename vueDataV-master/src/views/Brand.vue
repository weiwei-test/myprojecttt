      ...
      <section class="mainbox">
        <div class="item left">
          <div class="panel">
            <h2>功能模块</h2>
            <div>
              <button @click="normal" class="btn">dms下单</button>
            </div>
            <div>
              <button @click="mesacpt" class="btn">mes接单</button>
            </div>
        ...
        <div class="item center">
          <div class="resume">
            <div class="resume-hd">
              <ul>
                <li>
                  <countTo :startVal='startVal' :endVal='8888' :duration='6000' separator=""></countTo>
                </li>
                <li>
                  <countTo :startVal='startVal' :endVal='75' :duration='6000' separator=""></countTo>
                </li>
                <li>
                  <countTo :startVal='startVal' :endVal='30000000' :duration='6000' separator=""></countTo>
                </li>
              </ul>
            </div>
            <div class="resume-bd">
